  ...
  return (
    <>
       ...
       <Breadcrumbs className='p-5' aria-label="breadcrumb">
            ...
            <Typography className='text-black' >Create Loan Product</Typography>
        </Breadcrumbs>
      <h1 className='pt-6 pl-16 text-xl font-bold'>Loan Product</h1>
      <div className='p-12'>
        ...
        <div className='px-10 grid grid-cols-2 gap-2'>
          ...
          <div className='grid grid-cols-4 gap-2 mr-2'>
            ...
            <input name='name' required type="text" value={formValue.name} onChange={handleChange}  className="mt-2 block w-full px-2 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
            ...
            "/>
            <label className="block"><span className="font-serif block text-sm text-lg text-slate-700 ">Short Name :</span></label>
            
            <input name='shortName' required type="text" value={formValue.shortName} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
            ...
            "/> */}
            <label className="block"><span className="font-serif block text-sm text-lg text-slate-700 ">Original Loan :</span></label>
            
            <input name='originalLoan' required min={10000} type="number" value={formValue.originalLoan} onChange={handleChange}  className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
              focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
              disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
              invalid:border-pink-500 invalid:text-pink-600
              focus:invalid:border-pink-500 focus:invalid:ring-pink-500
