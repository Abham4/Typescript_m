    ...
    <>
      <Container className="bg-yellow-100 mt-10 mb-20 pb-20 rounded-lg drop-shadow-lg">
        <Breadcrumbs className="p-5" aria-label="breadcrumb">
          ...
          <Typography className="text-black">Create Sharing Product</Typography>
        </Breadcrumbs>
        <h1 className="pt-6 pl-16 text-xl font-bold">Share Product</h1>
        <div className="p-12">
          <form onSubmit={handleSubmit}>
            ...
            "
                ...
                <input
                  ...
                  className="float-right  my-5 bg-[#000] hover:bg-[#ffbb00] hover:text-black text-white text-white font-bold py-2 px-4 border border-blue-700 rounded"
                  value="Create"
                />
              </div>
